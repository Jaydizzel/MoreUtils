...
public class JDCreativeModeTab {
    ...
    public static final RegistryObject<CreativeModeTab> MAIN_TAB = CREATIVE_MODE_TABS.register("moreutils_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(BlockInit.COMPRESSED_ANDESITE.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(JDOres.QUARTZ_ORE.get());
                        pOutput.accept(JDOres.GRAVEL_IRON.get());
                        pOutput.accept(JDOres.GRAVEL_GOLD.get());
                        pOutput.accept(JDOres.GRAVEL_COPPER.get());
                        pOutput.accept(JDOres.NETHER_IRON_ORE.get());
                        pOutput.accept(JDOres.NETHER_COAL_ORE.get());
                        pOutput.accept(JDOres.NETHER_DIAMOND_ORE.get());
                        pOutput.accept(JDOres.NETHER_EMERALD_ORE.get());
                        pOutput.accept(JDOres.NETHER_REDSTONE_ORE.get());
                        pOutput.accept(JDOres.NETHER_LAPIS_ORE.get());
                        pOutput.accept(JDOres.NETHER_COPPER_ORE.get());
                        pOutput.accept(JDOres.END_COPPER_ORE.get());
                        pOutput.accept(JDOres.END_IRON_ORE.get());
                        pOutput.accept(JDOres.END_GOLD_ORE.get());
                        pOutput.accept(JDOres.END_DIAMOND_ORE.get());
                        pOutput.accept(JDOres.END_REDSTONE_ORE.get());
                        pOutput.accept(JDOres.END_EMERALD_ORE.get());
                        pOutput.accept(JDOres.END_LAPIS_ORE.get());
                        pOutput.accept(JDOres.END_COAL_ORE.get());
                        pOutput.accept(JDOres.NAUTILUS_ORE.get());
                        ...
                        pOutput.accept(BlockInit.CRATE_OF_APPLES.get());
                        pOutput.accept(BlockInit.CRATE_OF_KELP.get());
